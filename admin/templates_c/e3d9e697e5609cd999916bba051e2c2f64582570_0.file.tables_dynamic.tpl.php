...
" <?php if ($_smarty_tpl->tpl_vars['value']->key == 'id') {?> style="width:7%; margin-right:5px;"<?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['value']->key == 'backup' || $_smarty_tpl->tpl_vars['value']->key == 'gallery') {?> style="width:7%; padding-left:27px;"<?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['value']->key == 'folder') {?> style="width:7%; padding-left:10px;"<?php }?>
